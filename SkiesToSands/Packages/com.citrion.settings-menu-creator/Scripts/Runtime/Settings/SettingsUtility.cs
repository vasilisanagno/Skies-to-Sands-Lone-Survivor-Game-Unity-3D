...
namespace CitrioN.SettingsMenuCreator
{
  public static class SettingsUtility
  {
    ...
    {
      relations.Add(new StringToStringRelation(SettingsMenuVariables.VALUE_VISUALS_MULTIPLIER, multiplier));
    }

    public static void AddValueVisualsOffset(this List<StringToStringRelation> relations, string offset)
    {
      relations.Add(new StringToStringRelation(SettingsMenuVariables.VALUE_VISUALS_OFFSET, offset));
    }

    public static void AddValueSuffix(this List<StringToStringRelation> relations, string suffix)
    {
      relations.Add(new StringToStringRelation(SettingsMenuVariables.VALUE_SUFFIX, suffix));
    }

    public static void AddOneHundredMultiplierAndPercent(this List<StringToStringRelation> relations)
    {
      relations.Add(new StringToStringRelation(SettingsMenuVariables.VALUE_VISUALS_MULTIPLIER, "100"));
      relations.Add(new StringToStringRelation(SettingsMenuVariables.VALUE_SUFFIX, " %"));
    }
  }
}